...
OUTPUT  = bluepill-libopencm3-FreeRTOS_9.0.0-demo
...
SRC  =  src/main.c src/usart.c src/timer2.c \
...
# compiler settings
OPT     = -Os
CFLAGS  = -fdata-sections -ffunction-sections -Wall -mcpu=cortex-m3 -mlittle-endian -mthumb -I./src/freertos/include -I./src -I $(LOCM3_PATH)/include/ $(OPT) -DSTM32F1
ASFLAGS =  $(CFLAGS)
